...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Content categories for blog organization';
  ...
  attributes: {
    ...
    details: Schema.Attribute.Component<'shared.category-details', true> &
      Schema.Attribute.SetMinMax<
        {
          max: 5;
          min: 3;
...
export interface ApiPillarPillar extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Content pillars for blog categorization';
    displayName: 'Pillar';
    pluralName: 'pillars';
    singularName: 'pillar';
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
    details: Schema.Attribute.Component<'shared.pillar-details', true> &
      Schema.Attribute.SetMinMax<
        {
          max: 10;
        },
...
export interface ApiSiteSettingSiteSetting extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    gaEnabled: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    googleAnalyticsId: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 50;
      }>;
    gtmEnabled: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    > &
      Schema.Attribute.Private;
    metaPixelEnabled: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
...
export interface ApiSubcategorySubcategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Structured subcategories with parent-child relationship to Categories';
